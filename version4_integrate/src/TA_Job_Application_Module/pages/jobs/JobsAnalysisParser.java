...
public final class JobsAnalysisParser {
    ...
    /**
     * Ranking-card summary: prefer JSON {@code summary}; otherwise fall back to {@link #extractBriefAnalysis(String)}.
     * Normalize whitespace and truncate by {@code maxChars} to fit roughly within two lines.
     */
    public static String extractRankingSummaryPreview(String analysis, int maxChars) {
        ...
        // maxChars <= 0: do not truncate (used for long summary text on detail pages).
