...
public class Page_JobDetail {
    ...
    /** Left edge of card content: smaller for a flush-left layout. */
    ...
    private JPanel buildHeaderCard(Job job) {
        ...
        /** Default JPanel alignmentX is 0.5, which centers rows and makes the title look shifted right. */
    ...
    /** Horizontally center within the sidebar so fixed-width blocks and buttons align with the title. */
