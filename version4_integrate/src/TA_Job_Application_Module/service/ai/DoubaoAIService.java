...
public class DoubaoAIService {
    // Correct Volcengine text chat API endpoint.
    ...
    public String chat(String userMessage) throws Exception {
        ...
        // Use the correct Chat Completions API format.
        String requestBody = String.format(
                "{\n" +
                "    \"model\": \"doubao-seed-1-8-251228\",\n" +
                "    \"messages\": [\n" +
    ...
    private String parseChatResponse(String jsonResponse) {
        // If HTML is returned instead of JSON, the API call likely failed.
