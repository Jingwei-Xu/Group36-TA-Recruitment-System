...
public class JobApplicantsIntegrationPlaceholderPanel extends JPanel {
    ...
    private void rebuild() {
        ...
        body.setBorder(new EmptyBorder(16, MoUiTheme.GUTTER, 30, MoUiTheme.GUTTER));
        ...
        if (jid.isBlank()) {
            ...
            JPanel metricRow = new JPanel(new GridLayout(1, 3, 10, 0));
    ...
    private JPanel buildPageHeaderStrip() {
        ...
        strip.setBorder(BorderFactory.createCompoundBorder(
                ...
                new EmptyBorder(12, MoUiTheme.GUTTER, 12, MoUiTheme.GUTTER)
        ));
        ...
        back.setBorder(new EmptyBorder(4, 4, 4, 4));
