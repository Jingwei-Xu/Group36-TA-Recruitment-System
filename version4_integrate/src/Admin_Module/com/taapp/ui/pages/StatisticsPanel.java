...
public class StatisticsPanel extends Page {
    ...
    private void showDetailPage(PositionProgress p) {
        ...
        addBasicField(basic, 0, "Position", p.positionName);
        addBasicField(basic, 1, "Department", p.department);
        addBasicField(basic, 2, "Stage", p.stage);
        addBasicField(basic, 3, "Reminder", reminderFor(p));
        ...
        chartRows.setBorder(BorderFactory.createEmptyBorder(0, 0, 8, 0));
        ...
        progressCharts.setPreferredSize(new Dimension(900, 272));
        progressCharts.setMaximumSize(new Dimension(Integer.MAX_VALUE, 272));
        ...
        JScrollPane detailScroll = new JScrollPane(root);
        detailScroll.setBorder(BorderFactory.createEmptyBorder());
        detailScroll.getViewport().setBackground(JobsPortalUi.PAGE_BG);
    ...
    private static void addBasicField(JPanel basic, int row, String key, String value) {
        GridBagConstraints keyGbc = new GridBagConstraints();
        keyGbc.gridx = 0;
        keyGbc.gridy = row;
        keyGbc.weightx = 0;
        keyGbc.anchor = GridBagConstraints.WEST;
        keyGbc.fill = GridBagConstraints.NONE;
        keyGbc.insets = new Insets(0, 0, 10, 18);
        basic.add(labelKey(key), keyGbc);
        ...
        valGbc.fill = GridBagConstraints.HORIZONTAL;
        valGbc.insets = new Insets(0, 0, 10, 0);
        basic.add(labelVal(value), valGbc);
    }
    ...
    private static final class SimpleBar extends JPanel {
        private static final Color TRACK_BG = new Color(0xE9DDFE);
        private static final Color TRACK_BORDER = new Color(0xCFC2F7);
        ...
        protected void paintComponent(Graphics g) {
            ...
            int w = getWidth();
            int h = Math.max(10, getHeight() - 2);
            int y = (getHeight() - h) / 2;
            g2.setColor(TRACK_BG);
            g2.fillRoundRect(0, y, w, h, h, h);
            g2.setColor(TRACK_BORDER);
            g2.drawRoundRect(0, y, Math.max(0, w - 1), Math.max(0, h - 1), h, h);
