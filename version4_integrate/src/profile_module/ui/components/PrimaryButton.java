 ...
 * {@link JobsPortalUi.PurpleGradientButton} (arc 16, horizontal gradient, soft shadow + highlight).
 */
public final class PrimaryButton extends JButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color left = hover ? new Color(0x7C, 0x5C, 0xFF) : JobsPortalUi.PRIMARY_PURPLE;
        Color right = hover ? new Color(0x3F, 0x2B, 0xB8) : JobsPortalUi.DEEP_PURPLE;
