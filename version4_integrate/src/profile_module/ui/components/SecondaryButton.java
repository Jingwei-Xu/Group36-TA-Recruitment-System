...
/**
 * Outline secondary — matches {@link JobsPortalUi.OutlinePurpleButton}: white fill, lavender hover,
 * {@link JobsPortalUi#LIGHT_PURPLE_BORDER} stroke, primary / deep-purple label.
 */
public final class SecondaryButton extends JButton {
    ...
    public SecondaryButton(String text) {
        ...
        setForeground(JobsPortalUi.PRIMARY_PURPLE);
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                hover = true;
                setForeground(JobsPortalUi.DEEP_PURPLE);
                repaint();
            }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.setColor(hover ? JobsPortalUi.LAVENDER : Color.WHITE);
        g2.fillRoundRect(0, 0, w - 1, h - 1, ARC, ARC);
