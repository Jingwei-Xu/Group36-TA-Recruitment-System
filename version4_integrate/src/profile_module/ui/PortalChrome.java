...
public final class PortalChrome {
    ...
    public static JButton backLink(String text, Runnable action) {
        ...
        btn.setForeground(JobsPortalUi.PRIMARY_PURPLE);
        btn.setOpaque(false);
        ...
        btn.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                btn.setForeground(JobsPortalUi.DEEP_PURPLE);
            }
    ...
    public static JPanel header(Icon glyph,
        ...
        if (glyph != null) {
            JPanel iconTile = JobsPortalUi.wrapRoundedInner(new JLabel(glyph), 14,
        ...
        titleLabel.setForeground(JobsPortalUi.DARK_TEXT);
     ...
     * {@code JobsPortalUi.RoundedSurface}. {@code padding} is applied as the
     * card's inner content padding.
     */
    public static JobsPortalUi.RoundedSurface card(Insets padding) {
    ...
    public static JPanel iconBadge(Icon glyph, int size) {
        JPanel tile = JobsPortalUi.wrapRoundedInner(new JLabel(glyph), 12,
                JobsPortalUi.LAVENDER, JobsPortalUi.LIGHT_PURPLE_BORDER, 1f, false,
                new Insets(6, 6, 6, 6));
    ...
    /**
     * Compact "Edit XYZ" outline button used in {@link profile_module.ui.screens.ProfileScreen}'s
     * card headers. Renders the same outline-purple visual as
     * {@code JobsPortalUi.OutlinePurpleButton} but with smaller padding.
     */
    public static JButton compactOutline(String text, Runnable action) {
        JobsPortalUi.OutlinePurpleButton b = JobsPortalUi.outlineButton(text, new Font("Segoe UI", Font.BOLD, 12));
