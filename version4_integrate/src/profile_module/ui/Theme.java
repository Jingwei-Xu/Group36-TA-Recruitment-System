 ...
 * {@code TA_Job_Application_Module.pages.jobs.JobsPortalUi}).
 *
...
public final class Theme {
    ...
    /** Page chrome — JobsPortalUi.PAGE_BG (#FAFAFF). */
    public static final Color BG = new Color(0xFA, 0xFA, 0xFF);
    public static final Color SURFACE = Color.WHITE;
    /** Card / nav rules — JobsPortalUi.LIGHT_PURPLE_BORDER. */
    ...
    /** Re-purposed: previously navy → now JobsPortalUi.PRIMARY_PURPLE (#6D4DEB). */
