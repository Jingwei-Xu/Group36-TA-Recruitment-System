...
public final class ProfileScreen extends JPanel {
    ...
    private JPanel buildBody() {
        ...
        JPanel head = PortalChrome.header(
                JobsPortalUi.userIcon(JobsPortalUi.PRIMARY_PURPLE, 22),
                "My Profile",
    ...
    private JPanel buildPersonalCard() {
        ...
        card.add(cardHeader("Personal Information",
                JobsPortalUi.userIcon(JobsPortalUi.PRIMARY_PURPLE, 18),
                "Edit Profile",
    ...
    private JPanel buildSkillsCard() {
        ...
        card.add(cardHeader("Skills Information",
                JobsPortalUi.sparkleIcon(JobsPortalUi.PRIMARY_PURPLE, 18),
                "Edit Skills",
    ...
    private JPanel buildCvCard() {
        ...
        card.add(cardHeader("CV Information",
                JobsPortalUi.fileTextIcon(JobsPortalUi.PRIMARY_PURPLE, 18),
                "Manage CV",
                () -> app.showRoute(AppFrame.ROUTE_MANAGE_CV)), BorderLayout.NORTH);

        JobsPortalUi.RoundedSurface line = new JobsPortalUi.RoundedSurface(
        ...
        cvFileValue.setForeground(JobsPortalUi.DARK_TEXT);
