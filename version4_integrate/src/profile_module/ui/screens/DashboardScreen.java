 ...
 * overview), but every chrome element uses {@link JobsPortalUi} primitives.
 */
public final class DashboardScreen extends JPanel {
    ...
    private JPanel buildDashboardRoot() {
        ...
        cards.add(moduleCard(
                JobsPortalUi.userIcon(JobsPortalUi.PRIMARY_PURPLE, iconPx),
                "Profile Module",
        ...
        cards.add(moduleCard(
                JobsPortalUi.briefcaseGlyph(JobsPortalUi.PRIMARY_PURPLE, iconPx),
    ...
    private JPanel welcomeBanner() {
        ...
        JLabel iconLabel = new JLabel(JobsPortalUi.briefcaseGlyph(JobsPortalUi.PRIMARY_PURPLE, 24));
        JPanel iconTile = JobsPortalUi.wrapRoundedInner(iconLabel, 14, JobsPortalUi.LAVENDER,
                JobsPortalUi.LIGHT_PURPLE_BORDER, 1f, false, new Insets(8, 8, 8, 8));
    ...
    private JPanel moduleCard(Icon moduleIcon,
        ...
        JPanel iconWrap = JobsPortalUi.wrapRoundedInner(new JLabel(moduleIcon), 14,
                JobsPortalUi.LAVENDER, JobsPortalUi.LIGHT_PURPLE_BORDER, 1f, false,
        ...
        JobsPortalUi.PurpleGradientButton primary = JobsPortalUi.gradientButton(primaryCta, ctaFont);
        primary.addActionListener(e -> primaryAction.run());
        btnRow.add(primary);

        if (withSecondary && secondaryAction != null) {
            JobsPortalUi.OutlinePurpleButton secondary = JobsPortalUi.outlineButton("My Applications", ctaFont);
            secondary.setIcon(JobsPortalUi.fileTextIcon(JobsPortalUi.DEEP_PURPLE, 16));
    ...
    private JPanel quickOverviewPanel() {
        ...
        JLabel listIcon = new JLabel(JobsPortalUi.listLinesIcon(JobsPortalUi.PRIMARY_PURPLE, 18));
        head.add(listIcon);
        ...
        completionValue.setForeground(JobsPortalUi.PRIMARY_PURPLE);
        cvStatusValue.setFont(new Font("Segoe UI", Font.BOLD, 24));
        cvStatusValue.setForeground(JobsPortalUi.PRIMARY_PURPLE);
        appsValue.setFont(new Font("Segoe UI", Font.BOLD, 24));
        appsValue.setForeground(JobsPortalUi.PRIMARY_PURPLE);
