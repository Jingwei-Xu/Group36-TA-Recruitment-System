...
public final class EditProfileScreen extends JPanel {
    ...
    private JPanel buildBody() {
        ...
        JobsPortalUi.RoundedSurface card = PortalChrome.card(new Insets(18, 18, 18, 18));
        ...
        // Keep top alignment so the last row is not pushed to the middle when weighty=0.
    ...
    private JPanel labeled(String label, Component field) {
        ...
        lbl.setForeground(JobsPortalUi.DARK_TEXT);
        p.add(lbl);
