...
public final class ManageCvScreen extends JPanel {
    ...
    private final SecondaryButton viewBtn = new SecondaryButton("View CV");
    ...
    private JPanel buildBody() {
        ...
        page.add(PortalChrome.header(
                JobsPortalUi.fileTextIcon(JobsPortalUi.PRIMARY_PURPLE, 22),
                "CV Upload",
        ...
        JobsPortalUi.RoundedSurface card = PortalChrome.card(new Insets(18, 22, 18, 22));
        ...
        JobsPortalUi.RoundedSurface status = new JobsPortalUi.RoundedSurface(
                14, JobsPortalUi.LAVENDER, JobsPortalUi.LIGHT_PURPLE_BORDER, 1f, false, new BorderLayout());
        status.setBorder(new EmptyBorder(10, 16, 10, 12));
        status.setAlignmentX(Component.LEFT_ALIGNMENT);
        status.setMaximumSize(new Dimension(Integer.MAX_VALUE, 56));
        statusText.setForeground(JobsPortalUi.DARK_TEXT);
        ...
        JPanel actionWrap = new JPanel(new FlowLayout(FlowLayout.RIGHT, 8, 0));
        actionWrap.setOpaque(false);
        actionWrap.add(viewBtn);
        actionWrap.add(remove);
        status.add(actionWrap, BorderLayout.EAST);
        body.add(status);
        ...
        JobsPortalUi.RoundedSurface drop = new JobsPortalUi.RoundedSurface(
                16, new Color(0xFA, 0xFB, 0xFF), JobsPortalUi.LIGHT_PURPLE_BORDER, 1f, false, new BorderLayout());
        ...
        JLabel iconLabel = new JLabel(JobsPortalUi.fileTextIcon(JobsPortalUi.PRIMARY_PURPLE, 30),
    ...
    private JPanel sectionLabel(String text) {
        ...
        accent.setBackground(JobsPortalUi.PRIMARY_PURPLE);
        accent.setPreferredSize(new Dimension(4, 18));

        JLabel label = new JLabel(text);
        label.setFont(new Font("Segoe UI", Font.BOLD, 16));
        label.setForeground(JobsPortalUi.DARK_TEXT);
    ...
    private void openCvFile() {
        ...
        if (file == null) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    ...
                    "File Missing", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }
        if (!Desktop.isDesktopSupported() || !Desktop.getDesktop().isSupported(Desktop.Action.OPEN)) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Opening files is not supported on this system.\nPath: " + file.getAbsolutePath(),
                    "Unsupported", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }
        try {
